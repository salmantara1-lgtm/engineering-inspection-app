...
st.markdown("""
<style>
    /* تحويل اتجاه التطبيق بالكامل من اليمين لليسار */
    .stApp {
        direction: rtl;
    }
    
    /* محاذاة جميع النصوص والعناوين لليمين */
    p, h1, h2, h3, h4, h5, h6, .stMarkdown, .stText, span, div {
        text-align: right !important;
    }
    
    /* ضبط خانات الإدخال (Inputs) لتكتب من اليمين */
    .stTextInput input, .stTextArea textarea, .stSelectbox div {
        text-align: right !important;
        direction: rtl;
    }
    
    /* إصلاح اتجاه الأعمدة (Columns) */
    [data-testid="column"] {
        direction: rtl;
        text-align: right;
    }
    
    /* ضبط اتجاه التبويبات (Tabs) */
...
# ==========================================
# البنود الإدارية الثمانية (8) كما في الملف المرجعي
# ==========================================
ADMIN_CHECKS = [
...
# الأعمدة الآن ستظهر من اليمين لليسار بفضل الـ CSS
...
# حساب الترقيم التلقائي بناءً على المشروع المختار
...
with tab1:
    ...
    # البنود الإدارية الـ 8 بدقة كما طلبت
    gen_checks = {}
