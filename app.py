...
INSPECTIONS_DATA = {
    "استلام اعمال الحفر": [
        "مراجعة الميزانية الشبكية للأرض الطبيعية قبل الحفر ومطابقتها مع الميزانية المرفقة بالعقد.",
        "مراجعة إحداثيات حدود الحفر مع حدود المبنى طبقا لتقرير الجسات وتوصيات الاستشارى.",
    ...
    "استلام اعمال الاحلال": [
        ...
        "التأكد من الوزن المستخدم فى الدمك.",
        "التأكد من نتيجة اختبار الدمك قبل البدء فى الطبقة التالية.",
        "مطابقة طبقة الاحلال للعينة المعتمدة."
    ],
    ...
    "استلام نجارة القواعد الخرسانية المسلحة والسملات": [
        "مراجعة ابعاد القواعد المسلحة والسملات.",
    ...
    "استلام تسليح الاعمدة والحوائط": [
        ...
        "تأمين الغطاء الخرسانى بتركيب البسكويت."
    ],
